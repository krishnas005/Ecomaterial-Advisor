  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 border-b border-solid border-b-[#e7eef4] md:px-10">
      ...
      <nav className="hidden md:flex flex-1 justify-end gap-8 items-center">
        ...
        <a className="text-[#0d151c] text-sm font-medium" href="/login">
          Login
        </a>
      </nav>
      ...
      <div className="sidebar fixed top-0 right-0 w-64 h-full bg-white shadow-lg transform translate-x-full z-10">
